...
class ErrorCode
{
    ...
    //阿里Oss错误,取值范围:104600-104699
    const ALIOSS_PARAM_ERROR = 104600;
    const ALIOSS_CONNECT_ERROR = 104601;

    //打印错误,取值范围:104700-104799
    const PRINT_PARAM_ERROR = 104700;
    const PRINT_POST_ERROR = 104701;
    const PRINT_GET_ERROR = 104702;

    //微信服务商错误,取值范围:104800-104999
    const WXPROVIDER_CORP_PARAM_ERROR = 104800;
    const WXPROVIDER_CORP_POST_ERROR = 104801;
    const WXPROVIDER_CORP_GET_ERROR = 104802;

    //钉钉错误,取值范围:105000-105099
    const DING_TALK_PARAM_ERROR = 105000;
    const DING_TALK_POST_ERROR = 105001;
    const DING_TALK_GET_ERROR = 105002;

    //MEMCACHE错误,取值范围:105100-105199
    const MEMCACHE_CONNECTION_ERROR = 105100;
    ...
    //验证错误,取值范围:200001-200010
    const AUTH_LOGIN_ERROR = 200001;
    const AUTH_LOGIN_PASSWORD_ERROR = 200002;
    const AUTH_LOGIN_TIMEOUT_ERROR = 200003;
    ...
    protected static $msgArr = [
        ...
        self::AUTH_LOGIN_ERROR => '未登录',
        self::AUTH_LOGIN_PASSWORD_ERROR => '用户名或密码错误',
        self::AUTH_LOGIN_TIMEOUT_ERROR => '登录超时',
    ];
